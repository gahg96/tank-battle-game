export class Bullet {
    ...
    radius: number;
    active: boolean;
    type: 'cannon' | 'mg' | 'molotov' | 'shotgunPellet' | 'mine';
    damage: number;
    ...
    constructor(x: number, y: number, angle: number, owner: 'player' | 'enemy', type: 'cannon' | 'mg' | 'molotov' | 'shotgunPellet' | 'mine' = 'cannon', targetX?: number, targetY?: number) {
        this.x = x;
        this.y = y;
